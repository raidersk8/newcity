<div class="front-page light-content">
		...
		<div class="jcarousel">
			<ul>
				<?php if( have_rows('slider') ): ?>
					...
					<li class="<?php if($i==1) : ?>active<?php endif; ?>" style="background-image: url(<?php the_sub_field('img'); ?>);">
					</li>
					<?php endwhile; ?>
				<?php endif; ?>
			</ul>
	...
	<div class="wrap-main-slide-window">
		<div class="wrap-left-slide-window main-slide-window" id="slide-window-front-page">
			<div class="left-slide-window" id="slide-window-front-page-docs">
		...
		<div class="jcarousel">
			...
			<?php if( have_rows('slider') ): ?>
				...
				<li class="<?php if($i==1) : ?>active<?php endif; ?>" >
					<div class="wrap-left-slide-window" id="slide-<?php echo $i; ?>">
									...
									<div class="row">
										<div class="col-xs-4">
											<div class="global-left-padding">
												...
												<a href="#" class="btn btn-eggplant text-uppercase animated animate-btn no-preloader">Подобрать квартиру</a> <span class="hide-before-show-window"><a href="#slide-<?php echo $i; ?>" class="more animated switch-slide-window no-preloader"><span>Подробнее</span></a></span>
											</div>
										</div>
									</div>
								</div>
	...
	<div class="wrap-docs hide-before-show-window">
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-4">
					<div class="global-left-padding">
						<a class="docs switch-slide-window no-preloader" href="#slide-window-front-page" data-sub-href="#slide-window-front-page-docs"><i class="fa fa-file-text" aria-hidden="true"></i><span>Документы</span></a>
					</div>
				</div>
			</div>
		</div>
